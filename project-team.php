        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="tab-content" id="option-tabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="body text-center">
                                        <div class="team-lead">
                                            <img class="rounded-circle img-thumbnail mx-auto d-block mb-2" src="assets/images/sm/avatar2.jpg"
                                                alt="">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="header">
                                        <h2>eCommerce Development Team</h2>
                                    </div>
                                    <div class="body text-center">
                                        <div class="team-lead">
                                            <img class="rounded-circle img-thumbnail mx-auto d-block mb-2" src="assets/images/sm/avatar3.jpg"
                                                alt="">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="body text-center">
                                        <div class="team-lead">
                                            <img class="rounded-circle img-thumbnail mx-auto d-block mb-2" src="assets/images/sm/avatar4.jpg"
                                                alt="">
                    ...
                    <div class="tab-pane fade" id="pills-option2" role="tabpanel" aria-labelledby="pills-option2-tab">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="header">
                                    ...
                                    <div class="body text-left">
                                        <div class="row align-items-center team-lead">
