...
<head>
<title>:: Lucid HR :: Ui Treeview</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="ui-treeview.php">Treeview</a></li>
                                </ul>
                            </li>                            
                            <li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Treeview</h2>
                        <ul class="breadcrumb">
...
<script src="assets/js/pages/treeview/jstree.js"></script>
<script src="assets/js/pages/treeview/bootstrap-treeview.js"></script>
</body>
</html>
