...
<head>
<title>:: Lucid HR :: Widgets Data</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="widgets-data.php">Data Widgets</a></li>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Widgets Data</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>sales Team <small>Ranking 2th</small></h2>                        
                        ...
                        <div class="body">
                            <h6 class="m-b-15">Info about sales Team <span class="badge badge-success float-right">New</span></h6>                                
                            ...
                            <div class="cwidget-scroll">
                                <ul class="chat-widget m-r-5 clearfix">
                                    ...
                                    <li class="right">
                                        ...
                                        <div class="chat-info">
                                            <span class="message">Hi, Jessica<br> It is almost completed. I will send you an email later today.</span>
                                        </div>
                                    </li>
                                    <li class="left float-left">
                                        <img src="assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                                    ...
                                    <li>
                                        ...
                                        <div class="desc">
                                            ...
                                            <ul class="list-unstyled team-info margin-0 p-t-5">                                            
                                                <li><img src="http://via.placeholder.com/35x35" data-toggle="tooltip" data-placement="top" alt="Avatar"></li>
                                                <li><img src="http://via.placeholder.com/35x35" data-toggle="tooltip" data-placement="top" alt="Avatar"></li>
                                                <li><img src="http://via.placeholder.com/35x35" data-toggle="tooltip" data-placement="top" alt="Avatar"></li>
                                                <li><img src="http://via.placeholder.com/35x35" data-toggle="tooltip" data-placement="top" alt="Avatar"></li>                                            
                                            </ul>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <label class="fancy-checkbox mb-0">
                                        <input type="checkbox" name="checkbox" checked>
                                        <span>Surgical Ventricular Restoration</span>
                                    </label>
                                    <hr>
                                </li>
                                <li>
                                    <label class="fancy-checkbox mb-0">
                                        <input type="checkbox" name="checkbox">
                                        <span>Coronary Revascularization</span>
                                    </label>
                                    <hr>
                                </li>
                                <li>
                                ...
                                <li>
                                    <label class="fancy-checkbox mb-0">
                                        <input type="checkbox" name="checkbox">
                                        <span>Thoracic Aortic Dissection Repair</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
