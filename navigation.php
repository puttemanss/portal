            ...
            <div class="navbar-right d-none d-sm-block">               
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle icon-menu d-none d-sm-block" data-toggle="dropdown">
                                <i class="icon-bell"></i>
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle icon-menu d-none d-sm-block" data-toggle="dropdown"><i class="icon-equalizer"></i></a>
                        ...
                        <li>
                            <a href="page-login.php" class="icon-menu d-none d-sm-block"><i class="icon-login"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
