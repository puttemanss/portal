...
<head>
<title>:: Lucid HR :: Inbox Compose</title>
<meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="app-inbox.php">Inbox</a></li>
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="m-t-30">
                                ...
                                <a href="app-inbox.php" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
