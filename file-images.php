...
<head>
<title>:: Lucid HR :: File Images</title>
<meta charset="utf-8">
        ...
        <div class="sidebar-scroll">
            ...
            <div class="tab-content p-l-0 p-r-0">
                ...
                <div class="tab-pane animated fadeIn active" id="sub_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu active">
                            <li>
                            ...
                            <li class="active">
                                ...
                                <ul>                                    
                                    ...
                                    <li class="active"><a href="file-images.php">Images</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="card">
                        <div class="file">
                            <a href="javascript:void(0);">
                                ...
                                <div class="image">
                                    <img src="assets/images/image-gallery/12.jpg" alt="img" class="img-fluid">
                                </div>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">img21545ds.jpg</p>
                                    <small>Size: 2MB <span class="date text-muted">Dec 11, 2017</span></small>
                    ...
                    <div class="card">
                        <div class="file">
                            <a href="javascript:void(0);">
                                ...
                                <div class="image">
                                    <img src="assets/images/image-gallery/13.jpg" alt="img" class="img-fluid">
                                </div>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">img21545ds.jpg</p>
                                    <small>Size: 2MB <span class="date text-muted">Dec 11, 2017</span></small>
                    ...
                    <div class="card">
                        <div class="file">
                            <a href="javascript:void(0);">
                                ...
                                <div class="image">
                                    <img src="assets/images/image-gallery/15.jpg" alt="img" class="img-fluid">
                                </div>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">img21545ds.jpg</p>
                                    <small>Size: 2MB <span class="date text-muted">Dec 11, 2017</span></small>
