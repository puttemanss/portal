...
<head>
<title>:: Lucid HR :: Activities</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane animated fadeIn active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="app-activities.php"><i class="icon-badge"></i>Activities</a></li>
                            ...
                            <div class="timeline-item dark pb-0">
                                ...
                                <div class="msg">
                                    <div id="aniimated-thumbnials" class="row clearfix">
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/1.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/1.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/2.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/2.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/3.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/3.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/4.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/4.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/5.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/5.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-3 col-6 m-b-30"><a href="assets/images/image-gallery/6.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/6.jpg" alt=""></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
