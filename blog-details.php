...
<head>
<title>:: Lucid HR :: Blog Details</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul aria-expanded="true" class="collapse in">                                    
                                    ...
                                    <li class="active"><a href="blog-details.php">Blog Detail</a></li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Blog Details</h2>
                        <ul class="breadcrumb">
