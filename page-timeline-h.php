...
<head>
<title>:: Lucid HR :: Horizontal Timeline</title>
<meta charset="utf-8">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Horizontal Timeline</h2>
                        <ul class="breadcrumb">
