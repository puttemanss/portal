...
<head>
<title>:: Lucid HR :: Map Google</title>
<meta charset="utf-8">
...
<style> #simple_map, #map-markers, #street-view {min-height: 300px;} </style>
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a href="map-google.php">Google Map</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Google Map</h2>
                        <ul class="breadcrumb">
