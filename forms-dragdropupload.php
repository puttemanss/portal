...
<head>
<title>:: Lucid HR :: Form Drag & Drop</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="forms-dragdropupload.php">Drag &amp; Drop Upload</a></li>                                    
            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Drag & Drop File Upload</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <input type="file" id="dropify-event" data-default-file="assets/images/auth_bg.jpg">
                        </div>
                    </div>                    
                    <div class="card">
                        <div class="header">
