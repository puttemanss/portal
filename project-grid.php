...
<head>
<title>:: Lucid HR :: Projects Grid</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="project-grid.php">Projects Grid</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            ...
                            <h6 class="project-title text-primary mb-3"><a href="project-detail.php">iNext - Responsive Template</a></h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            ...
                            <h6 class="project-title text-primary mb-3"><a href="project-detail.php">Wordpress - Theme Design</a></h6>
                            <p><strong>Lorem Ipsum is</strong> simply dummy text of the printing and typesetting industry.</p>
                            <div class="project_progress">
                                <div class="progress progress-xs">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-left pro-img">
                            ...
                            <h6 class="project-title text-primary mb-3"><a href="project-detail.php">Logo Design</a></h6>
                            <p><strong>Lorem Ipsum is</strong> simply dummy text of the printing and typesetting industry.</p>
                            <div class="project_progress">
                                <div class="progress progress-xs">
                                    <div class="progress-bar l-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
