...
<head>
<title>:: Lucid HR :: Testimonials</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="page-testimonials.php">Testimonials</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Testimonials</h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="card testimonials">
                        <div class="body">
                            ...
                            <div class="m-t-30">
                                ...
                                <h6 class="mb-0 m-t-10">Jessica Doe</h6>
                                <span>CEO, Apple inc</span>
                            </div>
                        </div>
                    </div>
